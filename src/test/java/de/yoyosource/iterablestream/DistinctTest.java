...
class DistinctTest {
    ...
    void testCollectEach() {
        List<List<Integer>> list = Streamable.of(List.of(1, 2, 2, 3), Streamable.of(2, 4, 5, 5))
        ...
        Assertions.assertEquals(4, list.get(1).get(1));
        Assertions.assertEquals(5, list.get(1).get(2));
    }
}
